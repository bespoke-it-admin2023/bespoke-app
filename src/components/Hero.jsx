...
const Hero = () => (
  <section id="home" className={`md:flex-row flex-col w-full`}>
      <div className="w-full h-full bg-gradient-to-r from-indigo-500 via-blue-300 to-blue-500 text-white font-bold pl-5">
        <div className={`flex flex-row justify-between items-center`}>
          <div className='pl-12'>
            <h1 className="flex-1 font-poppins font-semibold ss:text-[75px] text-[12px] pb-6 text-white ss:leading-[100px] leading-[75px]">
